...
from legged_gym.envs.lite3_stand.Lite3_handstand_Config import LITECfg_Handstand, LITECfgPPO_Handstand
# from legged_gym.envs.GO2_Stand.GO2_Handstand.Go2_handstand_Config import GO2Cfg_Handstand,GO2CfgPPO_Handstand
class Lite3_stand(BaseTask):
    def __init__(self, cfg: LITECfg_Handstand, sim_params, physics_engine, sim_device, headless):
