...
from legged_gym.envs.lite3_jump.lite3_jump_config import Lite3JUMPCfg, Lite3JUMPPPO
...
def get_euler_xyz_tensor(quat):
    ...
    return euler_xyz
class Lite3Jump(BaseTask):
    def __init__(self, cfg: Lite3JUMPCfg, sim_params, physics_engine, sim_device, headless):
