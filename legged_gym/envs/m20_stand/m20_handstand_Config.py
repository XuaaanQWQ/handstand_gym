...
class M20HandstandCfg( LeggedRobotCfg ):
    ...
    class control( LeggedRobotCfg.control ):
        # PD Drive parameters:
        control_type = 'P'
        stiffness = {'HipX_joint': 80.0 , 'HipY_joint': 80., 'Knee_joint': 100., 'Wheel_joint': 0}  # [N*m/rad]
        damping = {'HipX_joint': 2.5 , 'HipY_joint': 2.5, 'Knee_joint': 2.5, 'Wheel_joint': 2}     # [N*m*s/rad]
    ...
    class asset:
        file = '{LEGGED_GYM_ROOT_DIR}/resources/robots/m20/urdf/CA9B_isaacgym.urdf'
        name = "m20_handstand"
        foot_name = "WHEEL"
        wheel_name = ["FL_Wheel_joint", "FR_Wheel_joint", "HL_Wheel_joint", "HR_Wheel_joint"]
        penalize_contacts_on = ["THIGH", "SHANK"]
        terminate_after_contacts_on = ["TORSO"]
        feet_name_reward=['FL_WHEEL', 'FR_WHEEL']
        contact_foot=['HL_WHEEL', 'HR_WHEEL']
    ...
    class rewards:
        class scales:
            ...
            action_rate = -0.01
            default_pos =-0.3  ####
            hip_default_pos = -0.5 # default position reward for hip joints
            front_wheels_vel = -5e-5 
            # contact=0.3
...
class M20HandstandCfgPPO(LeggedRobotCfgPPO):
    seed = 1
